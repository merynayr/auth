...
func (m *CreateUserInfo) validate(all bool) error {
	...
	if !_CreateUserInfo_Name_Pattern.MatchString(m.GetName()) {
		err := CreateUserInfoValidationError{
			field:  "Name",
	...
	if _, ok := _CreateUserInfo_Role_InLookup[m.GetRole()]; !ok {
		err := CreateUserInfoValidationError{
			field:  "Role",
...
func (m *CreateUserInfo) _validateHostname(host string) error {
...
func (m *CreateUserInfo) _validateEmail(addr string) error {
...
var _CreateUserInfo_Name_Pattern = regexp.MustCompile("^[A-Za-z]+( [A-Za-z]+)*$")

var _CreateUserInfo_Role_InLookup = map[Role]struct{}{
	0: {},
	1: {},
}
...
func (m *UpdateUserInfo) validate(all bool) error {
	...
	if !_UpdateUserInfo_Name_Pattern.MatchString(m.GetName()) {
		err := UpdateUserInfoValidationError{
			field:  "Name",
			reason: "value does not match regex pattern \"^[A-Za-z]+( [A-Za-z]+)*$\"",
		}
...
var _UpdateUserInfo_Name_Pattern = regexp.MustCompile("^[A-Za-z]+( [A-Za-z]+)*$")
