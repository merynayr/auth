...
//go:generate minimock -i github.com/merynayr/auth/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/merynayr/auth/internal/client/db"
)
